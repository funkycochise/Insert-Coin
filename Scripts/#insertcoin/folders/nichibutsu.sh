...
if [ "$res" == "1" ]; then
   ...
   add "$dir" "V"  "Kid no Hore Hore Daisakusen.mra" "_Booby Kids"
   add "$dir" "V"  "Legion - Spinner-87 (World ver 2.03).mra" "_Legion - Spinner-87"
   add "$dir" "V"  "Moon Cresta (Galaxian Hardware) [bl].mra" "_Moon Cresta" "" "STG"
   add "$dir" "V"  "Moon Quasar.mra" "_Moon Quasar" "" "STG"
   add "$dir" "V"  "Sei Senshi Amatelass.mra" "_Soldier Girl Amazon" "" "ACT"
   ...
   add "$dir" "H"  "Kozure Ookami (Japan).mra" "_Kozure Ookami"
