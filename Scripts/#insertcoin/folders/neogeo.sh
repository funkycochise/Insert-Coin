...
if [ "$res" == "1" ]; then
   ...
   add "$dir" "H"  "Jockey Grand Prix.mgl "" "" "PUZ"
   ...
   add "$dir" "H"  "Metal Slug 2 - Super Vehicle-001-II.mgl" "_Metal Slug 2" "_Metal Slug 2" "RNG"
   add "$dir" "H"  "Metal Slug 2 Turbo.mgl" "_Metal Slug 2" "_Metal Slug 2" "RNG"
   ...
   add "$dir" "H"  "Zed Blade - Operation Ragnaroks.mgl" "" "" "STG"
