...
add "$dir" "V" "Heavy Barrel (World).mra" "_Heavy Barrel" "" "ACT"
...
add "$dir" "H" "Karnov (US, rev 6).mra" "_Karnov" "" "ACT"
add "$dir" "H" "Midnight Resistance (World, set 1).mra" "_Midnight Resistance" "" "ACT"
add "$dir" "H" "Robocop (World revision 4).mra" "_Robocop" "" "ACT"
add "$dir" "H" "Secret Agent (World revision 3).mra" "_Secret Agent" "" "ACT"
add "$dir" "H" "Express Raider.mra" "_Express Raider" "" "ACT"
add "$dir" "H" "Western Express (Japan, rev 4).mra" "_Express Raider" "" "ACT"
dot