...
if [ "$resh" == "1" ] || [ "$resv" == "1" ]; then
   ...
   add "$dir" "H" "Puzzle Star (ver. 100MG, WORLD).mra" "_Puzzle Star" "" "PUZ"
   add "$dir" "H" "Puzzli 2 (ver. 100, WORLD).mra" "_Puzzli 2" "" "PUZ" "" "PUZ"
   add "$dir" "H" "Puzzli 2 Super (ver. 200, WORLD).mra" "_Puzzli 2 Super" "" "PUZ"
