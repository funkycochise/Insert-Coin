...
atarisys1=$(ini_get "$names" atarisys1)
atarisys2=$(ini_get "$names" atarisys2)
atlus=$(ini_get "$names" atlus)
...
cinematronics=$(ini_get "$names" cinematronics)
...
cavecv1k=$(ini_get "$names" cavecv1k)
...
jalecoms32=$(ini_get "$names" jalecoms32)
kaneko=$(ini_get "$names" kaneko)
kaneko16=$(ini_get "$names" kaneko16)
skns=$(ini_get "$names" skns)
...
segasys24=$(ini_get "$names" segasys24)
segasys32=$(ini_get "$names" segasys32)
segasyse=$(ini_get "$names" segasyse)
segamodel1=$(ini_get "$names" segamodel1)
seta=$(ini_get "$names" seta)
segakyugo=$(ini_get "$names" segakyugo)
seibu=$(ini_get "$names" seibu)
sesame=$(ini_get "$names" sesame)
snk=$(ini_get "$names" snk)
si=$(ini_get "$names" si)
stern=$(ini_get "$names" stern)
success=$(ini_get "$names" success)
sun=$(ini_get "$names" sun)
suna=$(ini_get "$names" suna)
tad=$(ini_get "$names" tad)
taito=$(ini_get "$names" taito)
taitob=$(ini_get "$names" taitob)
taitof2=$(ini_get "$names" taitof2)
taitof3=$(ini_get "$names" taitof3)
taitosj=$(ini_get "$names" taitosj)
taitox=$(ini_get "$names" taitox)
technos=$(ini_get "$names" technos)
technosoft=$(ini_get "$names" technosoft)
...
uplfb=$(ini_get "$names" uplfb)
visco=$(ini_get "$names" visco)
vs=$(ini_get "$names" vs)
williams=$(ini_get "$names" williams)
zn1=$(ini_get "$names" zn1)
zn1namco=$(ini_get "$names" zn1namco)
