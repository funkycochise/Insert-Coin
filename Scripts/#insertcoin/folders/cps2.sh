...
if  [ "$resh" == "1" ] || [ "$resv" == "1" ]; then
   ...
   add "$dir" "H" "Alien vs. Predator (Europe 940520).mra" "_Alien vs. Predator" "" "BEA"
   add "$dir" "H" "Armored Warriors (Europe 941024).mra" "_Armored Warriors" "" "BEA"
   add "$dir" "H" "Battle Circuit (Europe 970319).mra" "_Battle Circuit" "" "BEA"
   add "$dir" "H" "Capcom Sports Club (Europe 971017).mra" "_Capcom Sports Club" "" "SPO"
   add "$dir" "H" "Cyberbots Fullmetal Madness (Europe 950424).mra" "_Cyberbots Fullmetal Madness" "" "BEA"
   add "$dir" "H" "Darkstalkers The Night Warriors (Europe 940705).mra" "_Darkstalkers The Night Warriors" "" "VSF"
   add "$dir" "H" "Dungeons & Dragons Shadow over Mystara (Europe 960619).mra" "_Dungeons & Dragons Shadow over Mystara" "" "ACT"
   add "$dir" "H" "Dungeons & Dragons Tower of Doom (Europe 940412).mra" "_Dungeons & Dragons Tower of Doom" "" "ACT"
   ...
   add "$dir" "H" "Marvel Super Heroes (Europe 951024).mra" "_Marvel Super Heroes" "" "VSF"
   add "$dir" "H" "Marvel Super Heroes Vs. Street Fighter (Europe 970625).mra" "_Marvel Super Heroes Vs. Street Fighter"
   add "$dir" "H" "Marvel Vs. Capcom Clash of Super Heroes (Europe 980123).mra" "_Marvel Vs. Capcom Clash of Super Heroes"
   add "$dir" "H" "Mega Man 2 The Power Fighters (USA 960708).mra" "_Mega Man 2 The Power Fighters" "" "VSF"
   add "$dir" "H" "Mighty! Pang (Europe 001010).mra" "_Mighty! Pang" "" "ACT"
   add "$dir" "H" "Night Warriors Darkstalkers' Revenge (Europe 950316).mra" "_Night Warriors Darkstalkers' Revenge" "" "VSF"
   ...
   add "$dir" "H" "Quiz Nanairo Dreams Nijiirochou no Kiseki (Japan 960826).mra" "_Quiz Nanairo Dreams Nijiirochou no Kiseki"
   add "$dir" "H" "Ring of Destruction Slammasters II (Europe 940902).mra" "_Ring of Destruction Slam Masters II" "" "VSF"
   add "$dir" "H" "Street Fighter Alpha 2 (Europe 960229).mra" "_Street Fighter Alpha 2" "" "VSF"
   add "$dir" "H" "Street Fighter Alpha 3 (Europe 980904).mra" "_Street Fighter Alpha 3" "" "VSF"
   ...
   add "$dir" "H" "Super Puzzle Fighter II Turbo (Europe 960529).mra" "_Super Puzzle Fighter II Turbo" "" "VSF"
   ...
   add "$dir" "H" "Vampire Savior The Lord of Vampire (Europe 970519).mra" "_Vampire Savior The Lord of Vampire" "" "VSF"
   add "$dir" "H" "X-Men Children of the Atom (Europe 950331).mra" "_X-Men Children of the Atom" "" "VSF"
