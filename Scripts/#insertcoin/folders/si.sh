...
then
   ...
   addgame "280Z-ZZAP (US).mra" "_Space Invaders"
   ...
   addgame "Galaxy Wars (Universal, Set 1).mra" "_Space Invaders"
   addgame "Gun Fight.mra" "_Space Invaders"
   addgame "Laguna Racer.mra" "_Space Invaders"
   addgame "Lunar Rescue.mra" "_Space Invaders"
   addgame "Lupin III (Set 2).mra" "_Space Invaders"
   addgame "Sea Wolf (Set 1).mra" "_Space Invaders"
