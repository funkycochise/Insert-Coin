...
if  [ "$resh" == "1" ] || [ "$resv" == "1" ]; then
   ...
   add "$dir" "H" "Batman.mra" "_Batman" "" "ACT"
   ...
   add "$dir" "H" "Cloak & Dagger (rev 5).mra" "_Cloak & Dagger" "" "ACT"
   ...
   add "$dir" "H" "Escape from the Planet of the Robot Monsters (set 1).mra" "_Escape from the Planet of the Robot Monsters" "" "ACT"
