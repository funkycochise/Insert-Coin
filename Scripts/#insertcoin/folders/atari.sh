...
add "$dir" "H" "Indiana Jones (set 1).mra" "_Indiana Jones"
add "$dir" "H" "Indiana Jones (set 2).mra" "_Indiana Jones"
add "$dir" "H" "Indiana Jones (set 3).mra" "_Indiana Jones"
add "$dir" "H" "Indiana Jones (set 4).mra" "_Indiana Jones"
add "$dir" "H" "Indiana Jones (cocktail).mra" "_Indiana Jones"
add "$dir" "H" "Indiana Jones (german).mra" "_Indiana Jones"
add "$dir" "H" "Lunar Battle (Prototype).mra" "_Lunar Battle"
add "$dir" "H" "Lunar Lander.mra" "_Lunar Lander"
add "$dir" "H" "Marble Madness (set 1).mra" "_Marble Madness"
add "$dir" "H" "Marble Madness (set 2).mra" "_Marble Madness"
add "$dir" "H" "Marble Madness (set 3).mra" "_Marble Madness"
...
add "$dir" "H" "Road Blasters (cockpit, German, rev 1).mra" "_Road Blasters"
add "$dir" "H" "Road Blasters (cockpit, rev 1).mra" "_Road Blasters"
add "$dir" "H" "Road Blasters (cockpit, rev 2).mra" "_Road Blasters"
add "$dir" "H" "Road Blasters (upright, German, rev 1).mra" "_Road Blasters"
add "$dir" "H" "Road Blasters (upright, German, rev 2).mra" "_Road Blasters"
add "$dir" "H" "Road Blasters (upright, German, rev 3).mra" "_Road Blasters"
add "$dir" "H" "Road Blasters (upright, German, rev X).mra" "_Road Blasters"
add "$dir" "H" "Road Blasters (upright, rev 1).mra" "_Road Blasters"
add "$dir" "H" "Road Blasters (upright, rev 2).mra" "_Road Blasters"
add "$dir" "H" "Road Blasters (upright, rev 3)).mra" "_Road Blasters"
add "$dir" "H" "Road Blasters (upright, rev 4).mra" "_Road Blasters"
add "$dir" "H" "Road Runner (rev 1).mra" "_Road Runner"
add "$dir" "H" "Road Runner (rev 1p).mra" "_Road Runner"
