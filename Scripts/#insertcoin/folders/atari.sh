...
add "$dir" "H" "Battle Zone.mra" "_Battle Zone"
add "$dir" "H" "Battle Zone rev 1.mra" "_Battle Zone"
...
add "$dir" "H" "Missile Command (rev 1).mra" "_Missile_Command" "" "ACT"
add "$dir" "H" "Missile Command (rev 2).mra" "_Missile_Command" "" "ACT"
...
add "$dir" "H" "Red Baron (Revised Hardware).mra" "_Red Baron"
...
dir "$dir" "V" "_Atari Tetris"  "_Tetris" "" "PUZ"
dot