...
add "$dir" "H"  "Mega Twins (World 900619).mra" "_Mega Twins" "" "STG"
add "$dir" "H"  "Nemo (World 901130).mra" "_Nemo" "" "STG"
...
add "$dir" "H"  "Strider (USA, B-Board 89624B-2).mra" "_Strider" "" "ACT"
...
add "$dir" "H"  "Willow (World).mra" "_Willow" "" "ACT"
dot
