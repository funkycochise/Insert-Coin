...
then
   ...
   addgame  "Daimakaimura -Japan Resale Ver.-.mra" "_Ghouls'n Ghosts"
   addgame  "Daimakaimura -Japan-.mra" "_Ghouls'n Ghosts"
   addgame  "Dynasty Wars -USA, B-Board 89624B- -.mra" "_Dynasty Wars"
