...
if [ "$res" == "1" ]; then
   ...
   add "$dir" "V" "Image Fight (Japan).mra" "_Image Fight" "" "STG"
   add "$dir" "V" "Image Fight (World).mra" "_Image Fight" "" "STG"

   add "$dir" "H" "Daiku no Gensan (Japan, M72 hardware).mra" "_Hammerin' Harry" "" "ACT"
   add "$dir" "H" "Daiku no Gensan (Japan, M84 hardware).mra" "_Hammerin' Harry" "" "ACT"
   ...
   add "$dir" "H" "R-Type (Japan).mra" "_R-Type" "" "STG"
   add "$dir" "H" "R-Type (World).mra" "_R-Type" "" "STG"
   add "$dir" "H" "R-Type II (Japan).mra" "_R-Type II" "" "STG"
