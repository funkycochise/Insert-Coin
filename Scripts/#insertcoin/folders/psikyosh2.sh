...
if [ "$resh" == "1" ] || [ "$resv" == "1" ]; then
   ...
   add "$dir" "H"  "Lode Runner II - The Bungeling Strikes Back.mra" "_Lode Runner II - The Bungeling Strikes Back" "" "ACT"
   add "$dir" "H"  "Lode Runner III - The Golden Labyrinth.mra" "_Lode Runner III - The Golden Labyrinth" "" "ACT"
   add "$dir" "H"  "Lode Runner IV - Teikoku Karano Dasshutsu (JP).mra" "_Lode Runner IV - Teikoku Karano Dasshutsu" "" "ACT"
   ...
   #Sadd "$dir" "H"  "Sol Divide Sword Of Darkness (Korea).mra" "_Sol Divide Sword Of Darkness" "" "STG"
