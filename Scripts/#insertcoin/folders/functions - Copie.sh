...
if [ "$orientation" = "H" ] && [ "$stg_horizontal" == "1" ] && [ "$genre" == "STG" ]
then
   #echo "STG"
   if [ ! -d "$outdir/$genre_stg_h" ] 
   then
      #echo "Creating $outdir/$genre_stg_h"
      mkdir "$outdir/$genre_stg_h"
   fi
   if [ ! -d "$outdir/$genre_stg_h/$renamed" ] 
   then
...
if [ "$orientation" = "V" ] && [ "$stg_vertical" == "1" ] && [ "$genre" == "STG" ]
then
   #echo "STG"
   if [ ! -d "$outdir/$genre_stg_v" ] 
   then
      #echo "Creating $outdir/$genre_stg_v"
      mkdir "$outdir/$genre_stg_v"
   fi
   if [ ! -d "$outdir/$genre_stg_v/$renamed" ] 
   then
...
then
   ...
   if [ ! -d "$outdir/$stg_v" ] 
   then
      #echo "Creating $outdir/$stg_v"
      mkdir "$outdir/$stg_v"
   fi
   if [ ! -d "$outdir/$stg_v/$renamed" ] 
   then
      ln -s "$Alt/$sub" "$outdir/$stg_v/$renamed"
   fi
fi
