...
add "$dir" "H" "Bosconian - Star Destroyer (Midway, new version).mra" "_Bosconian"
...
add "$dir" "V" "Gorf (Program 1).mra" "_Gorf"
add "$dir" "V" "Gorf (Speech).mra" "_Gorf"
add "$dir" "V" "Gorf.mra" "_Gorf"
...
add "$dir" "V" "Pac-Man Plus.mra" "_Pacman Plus"
