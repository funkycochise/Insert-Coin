...
#0608
   add "$dir" "V" "Sky Smasher.mra" "_Sky Smasher"
   add "$dir" "H" "Cabal PGM.mra" "_Cabal PGM"
   add "$dir" "H" "Demon Front (ver. 105).mra" "_Demon Front" "" "RNG"
   add "$dir" "V" "DoDonPachi Dai-Ou-Jou Black Label (Japan, 2002.10.07 Black Ver., bootleg Knights of Valour Super Heroes conversion).mra" "_DoDonPachi Dai-Ou-Jou"
   add "$dir" "V" "DoDonPachi II - Bee Storm (World, ver. 102).mra" "_DoDonPachi II" 
   add "$dir" "H" "Dragon World 3 (ver. 106).mra" "_Dragon World 3"
   add "$dir" "H" "Dragon World 2001 (ver. 100, Japan).mra" "_Dragon World 2001" 
   add "$dir" "V" "Espgaluda (2003.10.15 Master Ver, bootleg cartridge conversion).mra" "_Espgaluda" 
   add "$dir" "V" "Ketsui Kizuna Jigoku Tachi (2003.01.01. Master Ver., bootleg cartridge conversion).mra" "_Ketsui Kizuna Jigoku Tachi" 
   add "$dir" "H" "Knights of Valour 2 (ver. 107).mra" "_Knights of Valour 2" 
   add "$dir" "H" "Knights of Valour Super Heroes (ver. 100, CN).mra" "_Knights of Valour Super Heroes"
   add "$dir" "H" "Martial Masters (ver. 104, 102, 102US).mra" "_Martial Masters" 
   add "$dir" "H" "Oriental Legend (ver. 126).mra" "_Oriental Legend" 
   add "$dir" "H" "Photo Y2K (ver. 102, Japanese Board).mra" "_Photo Y2K" 
