...
if [ "$resh" == "1" ] || [ "$resv" == "1" ]; then
   ...
   add "$dir" "V" "Akuu Gallet (Japan) (coc).mra" "_Air Gallet" "" "STG"
   add "$dir" "V" "Hotdog Storm (Korea).mra" "_Hotdog Storm" "" "STG"
   add "$dir" "V" "Hotdog Storm.mra" "_Hotdog Storm" "" "STG"
   add "$dir" "V" "Mazinger Z (Japan) (coc).mra" "_Mazinger Z" "" "STG"
   ...
   add "$dir" "H" "Bishoujo Senshi Sailor Moon (Version 95-03-22B, Japan) (coc).mra" "_Pretty Soldier Sailor Moon" "" "BEA"
   add "$dir" "H" "DenjinMakai.mra" "_DenjinMakai" "" "BEA"
