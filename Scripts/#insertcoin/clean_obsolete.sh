...
find $CORE -maxdepth 1 -type f -name "IGSPGM_*" ! -name "IGSPGM_20260617.rbf" -delete

find $CORE -maxdepth 1 -type f -name "PsikyoSH2_*" ! -name "PsikyoSH2_20260612.rbf" -delete

find "$ALT/_DoDonPachi Dai-Ou-Jou" -maxdepth 1 -type f -name "Ketsui*" -delete > /dev/null 2>&1
