...
function installPSX {
  ...
  if [ -f "/media/fat/Scripts/temp/PSX.zip" ];
  then
...
function installS32X {
  ...
  if [ -f "/media/fat/Scripts/temp/S32X.zip" ];
  then
    unzip -qq S32X.zip
    rm -r S32X.zip
...
function installSaturn {
  ...
  if [ -f "/media/fat/Scripts/temp/Saturn.zip" ];
  then
...
function installSGB {
  curl /media/fat/Scripts/temp https://raw.githubusercontent.com/funkycochise/Insert-Coin_Res/main/SGB.zip -O -k -s --output /media/fat/Scripts/temp/SGB.zip
  if [ -f "/media/fat/Scripts/temp/SGB.zip" ];
  then
    unzip -qq SGB.zip
    rm -r SGB.zip
    for f in $(ls ./*.rbf)
...
function installNeoGeo {
  curl /media/fat/Scripts/temp https://raw.githubusercontent.com/funkycochise/Insert-Coin_Res/main/NeoGeo.zip -O -k -s --output /media/fat/Scripts/temp/NeoGeo.zip
  if [ -f "/media/fat/Scripts/temp/NeoGeo.zip" ];
  then
    unzip -qq NeoGeo.zip
    rm -r NeoGeo.zip
    for f in $(ls ./*.rbf)
...
function installN64 {
  ...
  curl /media/fat/Scripts/temp https://raw.githubusercontent.com/funkycochise/Insert-Coin_Res/main/N64.zip -O -k -s --output /media/fat/Scripts/temp/N64.zip
  if [ -f "/media/fat/Scripts/temp/N64.zip" ];
  then
    unzip -qq N64.zip
    rm -r N64.zip
...
function installJaguar {
  ...
  if [ -f "/media/fat/Scripts/temp/Jaguar.zip" ];
  then
...
function installCDi {
  ...
  if [ -f "/media/fat/Scripts/temp/CDi.zip" ];
  then
...
function installPCE {
  ...
  if [ -f "/media/fat/Scripts/temp/TurboGrafx16.zip" ];
  then
...
function installNES {
  ...
  if [ -f "/media/fat/Scripts/temp/NES.zip" ];
  then
...
function installSNES {
  ...
  if [ -f "/media/fat/Scripts/temp/SNES.zip" ];
  then
