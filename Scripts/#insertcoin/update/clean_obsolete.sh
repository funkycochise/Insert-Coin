...
debug "Psikyo"
if [ "$debug" -eq 1 ]; then find $CORE -maxdepth 1 -type f -name "Psikyo_*" ! -name "Psikyo_20260830.rbf"
fi
find $CORE -maxdepth 1 -type f -name "Psikyo_*" ! -name "Psikyo_20260830.rbf" -delete
