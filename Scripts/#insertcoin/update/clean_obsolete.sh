...
find $CORE -maxdepth 1 -type f -name "Psikyo_*" ! -name "Psikyo_20260904.rbf" -delete
...
debug "SSV"
if [ "$debug" -eq 1 ]; then find $CORE -maxdepth 1 -type f -name "SSV*" ! -name "SSV_20260904.rbf"
fi
find $CORE -maxdepth 1 -type f -name "SSV*" ! -name "SSV_20260904.rbf" -delete
...
debug "Taito F3"
if [ "$debug" -eq 1 ]; then find $CORE -maxdepth 1 -type f -name "Rayforce_*" ! -name "Rayforce_20260909.rbf"
fi
find $CORE -maxdepth 1 -type f -name "Rayforce_*" ! -name "Rayforce_20260909.rbf" -delete
